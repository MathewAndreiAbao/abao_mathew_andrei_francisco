...
class Form_validation {
    ...
    public function __construct() {
        ...
        error_log("Form_validation.php loaded from: " . __FILE__); // Debug to confirm file loading
    }
    ...
    public function is_unique($table, $field, $custom_error = null) {
        error_log("is_unique called for table: $table, field: $field"); // Debug to confirm method call
            ...
            foreach ($field_rules as $rule => $param) {
                ...
                switch ($rule) {
                    ...
                    case 'is_unique':
                        ...
                        error_log("is_unique query: $sql, value: $value"); // Debug query
